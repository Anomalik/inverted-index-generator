...
public class ArgumentParser {
	...
	public static boolean isFlag(String arg) {
		return arg != null && arg.length() >= 2 && arg.charAt(0) == '-';
	}
	...
	public Path getPath(String flag, Path defaultValue) {
		Path pathValue = getPath(flag);
		return pathValue == null ? defaultValue : pathValue;
	}

	/**
	 * This function is in charge of returning the map of arguments as a string.
	 *
	 * @return the map member as a string
	 */
	@Override
